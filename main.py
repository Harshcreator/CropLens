...
label_image_path = tk.Label(root, text="Image Path:", font=("arial", 15), bg="light cyan")
...
button_browse = tk.Button(root, text="Browse", command=browse_image, font=("arial", 10), bg="#ff69b4", cursor="hand2", activebackground="#800080", activeforeground="white", relief="groove", bd=3, padx=10, pady=5, borderwidth=2, highlightthickness=0, highlightbackground="light cyan", highlightcolor="light cyan", takefocus=0)
button_browse.grid(row=0, column=2, padx=5, pady=5)

label_image = tk.Label(root)
label_image.grid(row=1, column=0, columnspan=3, padx=5, pady=5)

label_density = tk.Label(root, text="Seed Density (seeds/square meter):", font=("arial", 15), bg="light cyan")
...
button_calculate = tk.Button(root, text="Calculate", command=calculate, font=("arial", 10), bg="#ff6347", cursor="hand2", activeforeground="pink", activebackground="ghost white", relief="groove", bd=3, padx=10, pady=5, borderwidth=2, highlightthickness=0, highlightbackground="light cyan", highlightcolor="light cyan", takefocus=0)
